...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([bookTitle rangeOfString:searchTitle options:NSCaseInsensitiveSearch].location == NSNotFound) {
    ...
    // Sale Date as of 12/15/2017
    NSString *saleDateString = @"2017-12-15";
